...
<title>Tienda Ca Cargo, Inc.</title>
...
<header id="header" class="hidden-xs">
	<div class="topbar">
		<div class="container">
			<div class="row">
				<div class="col-sm-6"><div class="tollNum"><i class="fa fa-phone 2x" aria-hidden="true"></i> <a href="tel:+17863604291" class="sitetel"></a>+1 (786) 360-4291</div></div>
				<div class="col-sm-6">
    ...
    <div class="container">
    	<div class="row">
    		<div class="col-sm-2">
					<div class="logo">
						<a href="{{url('/')}}" class="logo-container"><img src="{{Config::get('app.url')}}/theme/images/logo.png" /></a></div></div>
    		<div class="col-sm-8">
				<div class="nav-link">
					<ul>
...
<footer id="footer">
  <div class="container">
        ...
        <div class="col-sm-5 col-lg-4">
          <h5>Síguenos</h5>
            ...
            <ul class="social">
              ...
              <li><a href="#" class="twitter"><i class="fa fa-instagram"></i></a></li>
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="copyrt">
          &copy; Tienda Ca Cargo, Inc. 2019 All Rights Reserved. <a href="terms-conditions.php">Términos y Condiciones</a>
        </div>
      </div>
    </div>
  </div>
